...
(defun I/capture-screenshot (basename)
  ...
  (cond ((file-exists-p (file-name-directory fullpath))
         (progn
        ...
        ((file-directory-p "./figures")
         (progn
           (call-process "screencapture" nil nil nil "-s" (concat "figures/" (concat basename ".png")))
           (I//insert-org-or-md-img-link "./figures/" (concat basename ".png"))))
        (t (progn
             (call-process "screencapture" nil nil nil "-s" (concat basename ".png"))
             (I//insert-org-or-md-img-link "./" (concat basename ".png")))))
  (insert "\n"))
...
(defun I/org-insert-src-block (src-code-type)
  ...
  (interactive
   (let ((src-code-types
          '("emacs-lisp" "python" "C" "sh" "scala" "java" "js" "clojure" "C++" "css"
