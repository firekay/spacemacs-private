;;; packages.el --- I Layer packages File for Spacemacs
;;
...
(defun I-misc/init-tiny ()
  (use-package tiny
    :defer t
    :init
    (spacemacs/set-leader-keys "oe" 'tiny-expand)))

(defun I-misc/post-init-helm ()
...
(defun I-misc/init-helm-github-stars ()
  (use-package helm-github-stars
    :commands (helm-github-stars)
    :init
    (setq helm-github-stars-username "I")))




(defun I-misc/post-init-fcitx ()
  (fcitx-aggressive-setup))

(defun I-misc/post-init-command-log ()
...
(defun I-misc/init-litable ()
  (use-package litable
    :init
    :defer t))

(defun I-misc/init-osx-dictionary ()
...
(defun I-misc/post-init-avy ()
  (progn
    (global-set-key (kbd "C-s-'") 'avy-goto-char-2)
    (global-set-key (kbd "M-'") 'avy-goto-char-2)))

(defun I-misc/post-init-ace-window ()
  (global-set-key (kbd "C-x C-o") #'ace-window))

(defun I-misc/init-discover-my-major ()
...
(defun I-misc/post-init-evil ()
  (progn
    ...
    ;; (defadvice evil-insert-state (around I/holy-mode activate)
...
(defun I-misc/init-visual-regexp ()
  (use-package visual-regexp
    :commands (vr/replace vr/query-replace)))

(defun I-misc/init-visual-regexp-steroids ()
...
(defun I-misc/init-multiple-cursors ()
...
(defun I-misc/post-init-persp-mode ()
  (setq persp-kill-foreign-buffer-behaviour 'kill)
  (setq persp-lighter nil)

  (defun I-kill-other-persp-buffers (&optional arg)
...
(defun I-misc/post-init-chinese-wbim ()
  (progn
...
(defun I-misc/init-ag ()
  (use-package ag
    :init))

(defun I-misc/post-init-erc ()
  (progn
    (add-hook 'erc-text-matched-hook 'my-erc-hook)
    (spaceline-toggle-erc-track-off)))

(defun I-misc/init-wrap-region ()
...
(defun I-misc/post-init-git-messenger ()
