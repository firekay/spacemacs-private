...
(defun I-ui/init-zilong-mode-line ()
  (defun I/display-mode-indent-width ()
  ...
  (setq-default mode-line-format
                (list
                 ...
                 '(:eval (I/display-mode-indent-width))
                 ;; line and column
...
(defun I-ui/post-init-spaceline ()
...
(defun I-ui/init-evil-vimish-fold ()
...
(defun I-ui/post-init-hl-anything ()
  (progn
...
(defun I-ui/post-init-pangu-spacing ()
  (progn
    ;; add toggle options
...
(defun I-ui/post-init-popwin ()
  (progn
    (push "*I/run-current-file output*" popwin:special-display-config)
    (delete "*Async Shell Command*" popwin:special-display-config)))

(defun I-ui/post-init-whitespace ()
  (progn
